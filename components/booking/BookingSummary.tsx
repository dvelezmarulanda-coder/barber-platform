    ...
    return (
        <div className="space-y-6">
            ...
            <button
                onClick={onConfirm}
                disabled={loading}
                className="w-full py-4 rounded-full bg-white text-black font-bold text-lg hover:bg-zinc-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
